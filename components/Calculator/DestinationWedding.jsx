...
// //     setFutureCost(Math.round(futureCostValue));
// //     setSIPAmount(Math.round(sipValue));
// //     setAdditionalAmount(Math.round(additionalNeeded));
// //   };
...
// //   const renderDisclaimer = () => {
// //     const disclaimerStyle = "text-xs text-gray-600";
...
// //             ))}
// //           </select>
// //           , is for illustration purposes only. SIP Calculator is designed to
// //           assist you in determining the appropriate amount.{" "}
// //         </p>
// //         <div className="text-right">
// //           <span
// //             onClick={() => setIsFullDisclaimer(false)}
...
// //       <div className="bg-white w-full max-w-7xl rounded-2xl shadow-2xl grid grid-cols-1 lg:grid-cols-3 gap-4 p-4 sm:p-8">
...
//       <div className="bg-white w-full max-w-7xl rounded-2xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 p-4 sm:p-8">
//         <div className="flex items-center justify-center mb-4 md:mb-0">
...
//               alt="Dream Car"
//               className="w-full h-auto object-cover"
//               style={{ maxWidth: "500px", width: "100%", height: "auto" }} // Inline style for precise control
//             />
//           </div>
//         </div>
  ...
  const statement = (
    <div className={styles.statementContainer}>
      <div className={styles.statementText}>
        <p>
          For your destination wedding, you may need{" "}
          ...
          to fund your destination wedding.
        </p>
      </div>
      ...
      <div className={styles.sloganText}>
        Destination wedding ka sapna skip nahi, SIP karo.
      </div>
      <button
        onClick={() => alert("Request for Callback")}
    ...
    <div className={styles.container}>
      ...
      <div className="space-y-4 sm:space-y-6">
        <div className={styles.header}>
          <FaGlassCheers className={styles.headerIcon} />
          <h1
        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            {renderInputBox(
              "Money required for your destination wedding? (₹)",
              currentCost,
              (e) => setCurrentCost(Number(e.target.value)),
              100000,
              5000000,
