  ...
  const statement = (
    <div className={styles.statementContainer}>
      <div className={styles.statementText}>
        <p>
          For your dream holiday, you may need{" "}
      ...
      <div className={styles.sloganText}>
        Dream Holiday ka sapna skip nahi, SIP karo.
      </div>
      <button
        onClick={() => alert("Request for Callback")}
    ...
    <div className={styles.container}>
      ...
      <div className="space-y-4 sm:space-y-6">
        <div className={styles.header}>
          <FaRegCalendarCheck className={styles.headerIcon} />
          <h1
        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            {renderInputBox(
              "Money required for your dream holiday? (₹)",
              currentCost,
              (e) => setCurrentCost(Number(e.target.value)),
              100000,
              5000000,
